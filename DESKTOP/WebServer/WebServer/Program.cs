...
namespace WebServer
{
    class Program
    {
        ...
        {
            const string Server_Directory = "C:\\Dropbox\\ValtechProjects\\HTTP_server\\WebSRW\\";
            const string Error_Message = "Server error";
            ...
            public void WriteToClient(string request)
            {
                ...
                Console.WriteLine("Content: " + GetContent(file_path));
